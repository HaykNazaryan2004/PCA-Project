# Երկու ձևով տվյալների վրա կիռարել ենք ներոնային ցանց(Fashion MNIST տվյալների բազայի վրա), որպեսզի հասկանանք PCA-ի ազդեցությունը ուսուցման ժամանակի և ճշտության վրա։ 
...
train_images <- array_reshape(train_images, c(nrow(train_images), 784)) / 255 # այս տողը դարձնում է մեկ չափանի վեկտոր մեր նկարներև և քանի որ պիքսելները արժեք են ընդոuնում (0,255) բաժանում ենք 255-ի,որպեսզի ընդունի (0,1)  արժեքներ 
